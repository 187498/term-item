    ...
    <!--左侧导航栏-->
 	<div id="wrapper">
        ...
        <!--输入框和按钮-->
           <div class="container">
				<div class="row">
						<form onsubmit="return submitFun(this);" class="form-horizontal" action="http://localhost:8080/zijinbao/withdraw">
							...
							<div class="col-md-8">
					                ...
					                <div class="form-group">
					                    <label for="inputEmail3" class="col-sm-3 control-label">请输入取款金额</label>
					                    <div class="col-sm-9">
					                        	<input type="number" class="form-control" id="inputEmail3" name="wit" " placeholder="取款金额">					                        
					                    </div>
					                </div>
						            <div class="form-group">
						                    <div class="col-sm-offset-2 col-sm-10">
						                        <button id="u_deposit" type="submit" class="btn btn-primary btn-lg btn-block" value="取款" >取款</button>
						                    </div>
						            </div>
					   	...
					   	<script type="text/javascript">
					            function submitFun(obj){
									...
									if(input.length <= 0) { //若输入的验证码长度为0
					                    alert("请输入取款金额！"); //则弹出请输入验证码
					                    return false;
					                }
					                else if(state == '0') { //若输入的验证码与产生的验证码不一致时
					                    alert("账户已冻结"); //则弹出验证码输入错误
					                    return false;
					                }
					          	}
	           			 </script>
