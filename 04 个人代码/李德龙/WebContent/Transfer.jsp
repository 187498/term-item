    ...
    <!--左侧导航栏-->
 	<div id="wrapper">
        ...
        <!--输入框和按钮-->
            <div class="container">
				<div class="row">
						<form onsubmit="return submitFun(this);" class="form-horizontal" action="http://localhost:8080/zijinbao/trans">
							...
							<div class="col-md-8">
									<div class="form-group">
					                    <div class="col-sm-offset-2 col-sm-10">
					                        ...
					                        <input type="hidden" name="u_state" value="${user.user_state }">
					                        <input type="hidden" name="u_account" value="${user.user_account }">
...
<%--         									<input type="hidden" name="u_phone" value="${user.user_phone }"> --%>
					                ...
					                <div class="form-group">
					                    <label for="to_account" class="col-sm-3 control-label">请输入转账账号</label>
					                    <div class="col-sm-9">
					                        	<input type="text" class="form-control" id="to_account" name="account"  placeholder="转账账号">					                        
					                    </div>
					                </div>
					                <div class="form-group">
					                    <label for="amount" class="col-sm-3 control-label">请输入转账金额</label>
					                    <div class="col-sm-9">
					                        	<input type="number" class="form-control" id="amount" name="amount"  placeholder="转账金额">					                        
					                    </div>
					                </div>
						            <div class="form-group">
						                    <div class="col-sm-offset-2 col-sm-10">
						                        <button id="u_deposit" type="submit" class="btn btn-primary btn-lg btn-block" value="转账" >确认</button>
						                    </div>
						            </div>
							...
							<div class="col-md-2">
						   	...
						   	<script type="text/javascript">
						            function submitFun(obj){
						                var input1 = document.getElementById("to_account").value;
