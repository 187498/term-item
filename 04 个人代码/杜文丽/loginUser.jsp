	        ...
	        <div class="col-md-4">
	            <h3>用户登录</h3><br>
	            	<c:if test="${errmsg != null }">
           			 ...
           			 <hr>
	            <form onsubmit="return submitFun(this);" method="post" class="form-horizontal" action="http://localhost:8080/zijinbao/login">
	                ...
	                <a href="loginManager.jsp" class="col-sm-offset-4">&nbsp;&nbsp;&nbsp;管理员登录</a><br><br><br><br>
	            </form>
