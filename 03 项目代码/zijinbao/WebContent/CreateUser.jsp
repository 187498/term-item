	        ...
	        <div class="col-md-4">
	            ...
	            <div class="form-group">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-sm-9">
	                        <input type="date" class="form-control" id="u_birth" name="birth" " placeholder="生日" >
	                    </div>
	                </div>
...
function submitFun(obj){
	var u_Pwd1 = document.getElementsByName('pwd1').value;
	var u_Pwd2=document.getElementsByName('pwd2').value;
	var u_account =document.getElementsByName('account').value;
	var u_money =document.getElementsByName('money').value;
	var u_name =document.getElementsByName('name').value;
	var u_addr =document.getElementsByName('address').value;
	var u_phone =document.getElementsByName('phone').value;
	var u_id =document.getElementsByName('user_id').value;
	var u_email =document.getElementsByName('email').value;
	var u_gender =document.getElementsByName('gender').value;
	var u_birth =document.getElementsByName('birth').value;
